#ifndef XVHISTOVVALUEAXIS_H
#define XVHISTOVVALUEAXIS_H
...
class xVHistoVValueAxis:public QObject,public QGraphicsItemGroup
{
    Q_OBJECT
public:
    xVHistoVValueAxis(int i,QObject *parent=nullptr);
